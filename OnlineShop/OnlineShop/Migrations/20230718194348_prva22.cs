...
{
    /// <inheritdoc />
    public partial class prva22 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    slikapostojeca = table.Column<byte[]>(name: "slika_postojeca", type: "varbinary(max)", nullable: true),
                    evidentirao = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    modifikovao = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isSpecijalna = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    jelotkljucan = table.Column<bool>(name: "jel_otkljucan", type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlikaKupca = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    jelObavijesten = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalnaCijena = table.Column<float>(type: "real", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ukupno = table.Column<float>(type: "real", nullable: true),
                    UkupnoProizvoda = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KupacId = table.Column<int>(type: "int", nullable: false),
                    ProdavnicaId = table.Column<int>(type: "int", nullable: false),
                    Evidentirao = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    jelpromijenjenstatus = table.Column<bool>(name: "jel_promijenjen_status", type: "bit", nullable: false),
                    jelposlanaprouka = table.Column<bool>(name: "jel_poslana_prouka", type: "bit", nullable: false),
                    PrethodniStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    jelkliknuootkazana = table.Column<bool>(name: "jel_kliknuo_otkazana", type: "bit", nullable: true)
                },
                constraints: table =>
                {
